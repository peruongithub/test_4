...
class Arr
{
     ...
     * @param   array $keys [key,key,key=>default,key=>default,...]
     * @return  array
     */
    public static function extract(&$array, array $keys)
    {
        ...
        foreach ($keys as $key => $default) {
            ...
            static::setData($found, $key, static::getData($array, $key, $default));
        }
     ...
     */
    public static function setData(& $array, $path, $value, $delimiter = null)
    {
        if (!$delimiter) {
     ...
     * @return  mixed
     */
    public static function getData(array &$array, $path, $default = null, $delimiter = null)
    {
        if (is_array($path)) {
            // The path has already been separated into keys
            $keys = $path;
        ...
        do {
            ...
            if (isset($array[$key])) {
                ...
                foreach ($array as $arr) {
                    $value = static::getData($arr, implode('.', $keys));
                    if ($value) {
                        $values[] = $value;
                    }
                }
